...
public class PremiumUserDto extends UserDto {
    ...
    public static final class PremiumUserDtoBuilder {
        ...
        public PremiumUserDtoBuilder validEmail(Booking validEmail) {
            this.validEmail = validEmail;
            return this;
        }

        public PremiumUserDtoBuilder isExpired(Booking isExpired) {
            this.isExpired = isExpired;
            return this;
        }

        public PremiumUserDtoBuilder isEnabled(Booking isEnabled) {
            this.isEnabled = isEnabled;
            return this;
        }

        public PremiumUserDtoBuilder isCredentialsNonExpired(Booking isCredentialsNonExpired) {
