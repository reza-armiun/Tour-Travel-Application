...
<%--                <img src="https://t-cf.bstatic.com/xdata/images/hotel/square200/353213460.webp?k=c7ca29527141ae126fc6b359cb3fd1b67d4709e0b558db28ba5d8bc3a58ece66&o="--%>
<%--                >--%>
<%--            </div>--%>
<%--            <div class="tour__container">--%>
<%--                <div class="tour__content">--%>
<%--                    <div class="tour__content-main">--%>
<%--                        <div class="tour__content-header">The People Tours</div>--%>
<%--                        <div class="tour__content-text">--%>
<%--                            The People - Tours has a restaurant, bar, a shared--%>
<%--                        </div>--%>
<%--                    </div>--%>
...
<%--                            Price From--%>
<%--                            <div class="currency">25.88</div>--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                </div>--%>
<%--                <div class="tour__container-book">--%>
<%--                    <div class="bui-button">Book Now</div>--%>
<%--                </div>--%>
<%--            </div>--%>
<%--        </div>--%>
<%--        <div class="tour">--%>
...
<%--                        <div class="tour__price">--%>
<%--                            Price From--%>
<%--                            <div class="currency">25.88</div></div>--%>
<%--                    </div>--%>
<%--                </div>--%>
<%--                <div class="tour__container-book">--%>
<%--                    <div class="bui-button">Book Now</div>--%>
