...
public class CityTour extends Tour {
    ...
    public CityTour(String id, Instant createdAt, Instant modifiedAt, String createdBy, String modifiedBy, String name, String guide, String description, String imgUrl, TourRate rate, Instant date, Set<TourCategory> categories, Booking booking, TourismManager tourismManager, Set<SchedulePlan> schedulePlans) {
        super(id, createdAt, modifiedAt, createdBy, modifiedBy, name, TourType.CITY, guide, description, imgUrl, rate, date, categories, booking, tourismManager, schedulePlans);
    }
    ...
    public CityTour cloneWithId(String id) {
        return new CityTour(id, createdAt, modifiedAt, createdBy, modifiedBy, name, guide, description, imgUrl, rate, date, categories, booking, tourismManager, schedulePlans);
    }
    ...
    public static final class CityTourBuilder {
        ...
        public CityTourBuilder imgUrl(String imgUrl) {
            this.imgUrl = imgUrl;
            return this;
        }

        public CityTourBuilder rate(TourRate rate) {
            this.rate = rate;
            return this;
        }
