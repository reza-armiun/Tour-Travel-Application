...
public class HotelToHotelDto implements Mapper<Hotel, HotelDto> {
    ...
    public HotelDto convert(Hotel hotel) {
        return HotelDto.HotelDtoBuilder.aHotelDto()
                ...
                .address(hotel.getAddress() != null ? addressToAddressDto.convert(hotel.getAddress()) : null)
                .accommodationProvider(hotel.getAccommodationProvider() != null ? accProviderToAccProviderDto.convert(hotel.getAccommodationProvider()): null)
