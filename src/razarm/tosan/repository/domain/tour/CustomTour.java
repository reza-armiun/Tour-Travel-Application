...
public class CustomTour extends Tour{
    ...
    public CustomTour(String id, Instant createdAt, Instant modifiedAt, String createdBy, String modifiedBy, String name, TourType type, String guide, String description, Instant date, Set<TourCategory> categories, Booking booking, TourismManager tourismManager, Set<SchedulePlan> schedulePlans) {
        super(id, createdAt, modifiedAt, createdBy, modifiedBy, name, type, guide, description, date, categories, booking, tourismManager, schedulePlans);
    }
