...
public class AdminData extends UserData {
    ...
    public AdminData(String id, Instant createdAt, Instant modifiedAt, String createdBy, String modifiedBy, String name, String username, String password, String email, String phone, Long nationalId, Booking validEmail, Booking isExpired, Booking isEnabled, Booking isCredentialsNonExpired, Set<String> authorityIds) {
    ...
    public static final class AdminDataBuilder {
        ...
        public AdminDataBuilder validEmail(Booking validEmail) {
            this.validEmail = validEmail;
            return this;
        }

        public AdminDataBuilder isExpired(Booking isExpired) {
            this.isExpired = isExpired;
            return this;
        }

        public AdminDataBuilder isEnabled(Booking isEnabled) {
            this.isEnabled = isEnabled;
            return this;
        }

        public AdminDataBuilder isCredentialsNonExpired(Booking isCredentialsNonExpired) {
