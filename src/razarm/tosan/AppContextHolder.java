...
import razarm.tosan.repository.inMemoryImpl.tour.TourRateRepositoryImpl;
...
///////////////////////////////////////////////////////TOUR/////////////////////////////////////////////////////
    ...
    private static final TourToTourDto tourToTourDto;
    private static final TourDtoToTour tourDtoToTour ;
    ...
    private static final TourRateDataToTourRate tourRateDataToTourRate;
    private static final TourRateToTourRateData tourRateToTourRateData;
    private static final TourRateRepository tourRateRepository;
    private static final TourRateService tourRateService;


    static {
        tourDtoToTour = new TourDtoToTour(tourismManagerDtoToTourismManager, schedulePlanDtoToSchedulePlan);
        tourToTourDto = new TourToTourDto(tourismManagerToTourismManagerDto, schedulePlanToSchedulePlanDto);
        ...
        tourRateDataToTourRate = new TourRateDataToTourRate();
        tourRateToTourRateData = new TourRateToTourRateData();
    ...
    public static  TourRateRepository getTourRateRepository(){
        return tourRateRepository;
    }
    public static TourRateService getTourRateService() {
        return tourRateService;
    }
