...
public class MockDataInitializer {
    ...
    public static void initialize() throws InvalidAttributeValueException, UserNotFoundException {
        getMockAddresses().forEach(System.out::println);
        System.out.println();
        getMockVehicles().forEach(System.out::println);
        System.out.println();
        getMockAccommodations().forEach(System.out::println);
        System.out.println();
        getMockFoods().forEach(System.out::println);
        System.out.println();
        getMockUsers().forEach(System.out::println);
        System.out.println();
        getMockBookings()
    ...
    private static List<BookingDto> getMockBookings() throws UserNotFoundException {
        ...
        bookService.bookingTour(signupRequest1.getUsername(), savedTour1.getId(), mockBooking);
