...
import razarm.tosan.repository.inMemoryImpl.accommodation.AccommodationOrderRepositoryImpl;
...
public final class AppContextHolder {
    ...
    private static final UserRepository userRepository  =  new UserRepositoryInMemoryImpl(userToUserData, userDataToUser);
    ...
    private static final AuthService authService = new AuthServiceImpl(userRepository, userSessionRepository, passwordEncoder, userToUserDto);
///////////////////////////////////////////////////////ADDRESS/////////////////////////////////////////////////////
    ...
    private static final AddressRepositoryImpl addressRepository = new AddressRepositoryImpl(
...
private static final FoodProviderDataToFoodProvider foodProviderDataToFoodProvider = new FoodProviderDataToFoodProvider();
    ...
    private static final FoodOrderRepository foodOrderRepository = new FoodOrderRepositoryImpl(
    ...
    private static final FoodOrderService foodOrderService = new FoodOrderServiceImpl(
...
//    private static final AccommodationOrderRepository accommodationOrderRepository = new AccommodationOrderRepositoryImpl(accOrderToAccOrderData, accOrderDataToAccOrder);
    private static final AccommodationOrderRepository accommodationOrderRepository = new AccommodationOrderInStorageImpl(accOrderToAccOrderData, accOrderDataToAccOrder);
    ...
    private static final  AccommodationOrderService accommodationOrderService = new AccommodationOrderServiceImpl(accommodationOrderRepository, accOrderToAccOrderDto, accOrderDtoToAccOrder);
///////////////////////////////////////////////////////VEHICLE/////////////////////////////////////////////////////
private static final VehicleToVehicleData vehicleToVehicleData = new VehicleToVehicleData();
    ...
    private static final VehicleOrderRepositoryImpl vehicleOrderRepository = new VehicleOrderRepositoryImpl(
    ...
    private static final  VehicleOrderService vehicleOrderService = new VehicleOrderServiceImpl(
...
///////////////////////////////////////////////////////TOUR/////////////////////////////////////////////////////
    ...
    private static final TourRepository tourRepository = new TourRepositoryImpl(tourToTourData, tourDataToTour, schedulePlanDataToSchedulePlan, accommodationOrderRepository, vehicleOrderRepository, foodOrderRepository);
    ...
    private static final BookingRepository bookingRepository = new BookingRepositoryImpl(bookingToBookingData ,bookingDataToBooking, tourRepository, userRepository);
    ...
    private static final TourService tourService = new TourServiceImpl(tourRepository, tourToTourDto, tourDtoToTour);

    private static final BookingToBookingDto bookingToBookingDto = new BookingToBookingDto(travelerToTravelerDto, tourToTourDto, userToUserDto);
    private static final BookingDtoToBooking bookingDtoToBooking = new BookingDtoToBooking(travelerDtoToTraveler, tourDtoToTour, userDtoToUser);
    private static final BookingService bookingService =  new BookingServiceImpl(userRepository, bookingRepository, tourRepository, bookingDtoToBooking, bookingToBookingDto);
